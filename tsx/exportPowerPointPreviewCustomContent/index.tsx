...
export const ChartExample = () => {
  ...
  let logo =
    `<svg>
        <text fill="#039be5" 
            style="font-size: 64px; font-family: Roboto-Bold;" x="50%" y="50%"
  ...
  return  <OrgChartReact 
            ...
            menu={{ 
              powerpointPreview: { text: "Export PowerPoint", icon: OrgChartJS.icon.powerpoint(24, 24, "#7A7A7A"), onClick: powerpointPreview }
            }}
            enableSearch={false}
            data={[
